    ...
    <Body style={{ backgroundColor: "#FAF8F3", margin: 0 }}>
      <Container style={container}>
        ...
        <Section style={{ marginTop: 16 }}>
          ...
          <Text style={value}>
            present: {String(p.secretPresent ?? false)} · prefix ok:{" "}
            {String(p.secretPrefixOk ?? false)}
          </Text>
        ...
        <Text style={{ color: "#666", fontSize: 12, marginTop: 16 }}>
          ...
          STRIPE_WEBHOOK_SECRET_LIVE using the signing secret from the current live Stripe webhook
          endpoint.
        </Text>
      </Container>
    </Body>
