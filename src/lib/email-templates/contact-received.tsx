  ...
  <Html lang="en">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={body}>
          In the meantime, feel free to keep dreaming — proposals under Sintra sunsets, Alentejo
          vineyards, private wild beaches. When we reply, we'll shape it around you.
        </Text>
        <Hr style={hr} />
        <Text style={body}>Warmly,</Text>
