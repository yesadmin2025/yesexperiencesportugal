...
const heading = { color: "#2E2E2E", fontFamily: 'Newsreader, serif', fontSize: 26, lineHeight: 1.2, margin: "0 0 18px" } as const;
...
const value = { color: "#295B61", fontFamily: 'Newsreader, serif', fontSize: 19, margin: "0 0 12px" } as const;
