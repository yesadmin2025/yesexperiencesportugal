  ...
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={lede}>
          A local designer will confirm timings and finalise availability within a few hours. We'll
          reply to the email you used to book.
        </Text>
        ...
        <Text style={footer}>
          You'll receive a follow-up with confirmed timings and the secure payment link before any
          charge. If anything looks off, just reply to this email.
        </Text>
