 ...
 *
 * Returns ONE editorial line (Newsreader italic, ≤80 chars, PT-PT) describing
    ...
    try {
      ...
      > = {
        pt: {
          ...
          pace: "Ritmo",
          region: "Região",
          stops: "Paragens já escolhidas",
          none: "nenhuma ainda",
          instruct: "Devolve apenas a frase, sem aspas, sem prefixos.",
        },
        en: {
          mood: "Mood",
          with: "With",
