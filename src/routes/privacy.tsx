      ...
      <section className="bg-[color:var(--ivory)] py-20 md:py-28">
        <div className="container-x max-w-2xl mx-auto">
          ...
          <h1 className="serif mt-3 text-[2rem] md:text-[2.8rem] leading-[1.1] tracking-[-0.018em] text-[color:var(--charcoal)] font-medium">
            Privacy{" "}
            <span className="italic font-normal text-[color:var(--teal)]">policy.</span>
          </h1>
          ...
          <div className="mt-10 space-y-7 text-[15px] leading-[1.75] text-[color:var(--charcoal-soft)]">
            <p>
              We keep things simple. YES experiences Portugal only collects
              the information needed to design your private experience,
              confirm your booking, and stay in touch about your trip.
            </p>
            <h2 className="serif text-[1.4rem] text-[color:var(--charcoal)] font-medium">
              What we collect
            </h2>
            <p>
              Name, email, phone number, party size, travel dates and any
              preferences you share with us. Payment details are handled by
            ...
            <p>
              To plan and operate your experience, to send booking
              confirmations and trip information, and — only if you opt in —
              occasional editorial notes about Portugal. We never sell your
              data.
            </p>
            <h2 className="serif text-[1.4rem] text-[color:var(--charcoal)] font-medium">
              Your rights
            ...
            <p>
              Under GDPR you can access, correct or delete your personal
              data at any time. Write to us and we will respond within 30
              days.
            </p>
