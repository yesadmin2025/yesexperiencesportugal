...
/**
 * /private-tours-cascais → /private-tours-sintra-cascais#cascais (301).
 *
 ...
 */
export const Route = createFileRoute("/private-tours-cascais")({
  loader: () => {
    throw redirect({ href: "/private-tours-sintra-cascais#cascais", statusCode: 301 });
  },
});
