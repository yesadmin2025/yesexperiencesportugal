...
const REGION = findLisbonRegion("/private-tours-azeitao-setubal");
const PAGE_URL = `${WEBSITE_URL}${REGION.path}`;

export const Route = createFileRoute("/private-tours-azeitao-setubal")({
  head: () => ({
    meta: [
      { title: REGION.title },
    ...
    scripts: [
      ...
      jsonLdScript(
        itemListLd({
          name: `Private wine tours in ${REGION.name}`,
          path: REGION.path,
