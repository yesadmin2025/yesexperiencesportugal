                ...
                <tr className="border-b border-[color:var(--border)]">
                  {["Day trip", "Drive", "Distance", "Length", "From", "Best for"].map((h) => (
                    <th
                      key={h}
                      scope="col"
                      className="py-3 pr-4 font-sans text-[11px] uppercase tracking-[0.22em] font-bold text-[color:var(--charcoal)]"
                    >
                      {h}
                    </th>
                  ))}
            ...
            {COMPARISON.map(({ row, tour }) => (
              ...
              >
                ...
                <dl className="mt-3 grid grid-cols-2 gap-x-4 gap-y-2 text-[13.5px] text-[color:var(--charcoal-soft)]">
                  <div>
                    <dt className="font-sans text-[11px] uppercase tracking-[0.2em]">Drive</dt>
                    <dd className="mt-0.5">{row.drive}</dd>
                  </div>
                  <div>
                    <dt className="font-sans text-[11px] uppercase tracking-[0.2em]">Distance</dt>
                    <dd className="mt-0.5">{row.distance}</dd>
                  </div>
                  <div>
                    <dt className="font-sans text-[11px] uppercase tracking-[0.2em]">Length</dt>
                    <dd className="mt-0.5">{tour?.durationHours ?? row.shape}</dd>
                  </div>
                  <div>
                    <dt className="font-sans text-[11px] uppercase tracking-[0.2em]">From</dt>
