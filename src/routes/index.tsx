...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "twitter:image:alt", content: "A private coastal journey with YES Experiences Portugal" },
