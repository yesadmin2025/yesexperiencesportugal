...
const PILLARS: { eyebrow: string; title: string; body: string; cta: { to: string; tourId?: string; label: string } }[] = [
  {
        ...
        <header className="reveal pt-32 md:pt-40 pb-12 md:pb-16 bg-[color:var(--sand)]">
          <div className="container-x max-w-3xl text-center">
            ...
            <SectionTitle as="h1" size="anchor" spacing="loose">
              ...
              <SectionTitle.Em>quietly done.</SectionTitle.Em>
            </SectionTitle>
          ...
          <div className="container-x max-w-2xl">
            <div className="prose-yes">
              <p className="text-[16px] md:text-[17px] text-[color:var(--charcoal)] leading-[1.85]">
                ...
                travelers who want the country shown properly — not a bus route with a badge on
                it. Every day is private, all-inclusive, and priced with real numbers.
              </p>
