...
export const Route = createRootRoute({
  ...
  head: () => ({
    ...
    links: [
      ...
      // Approved YES hierarchy: Montserrat display + Georgia editorial serif + Inter body/UI.
      // Georgia is system-native, so only Montserrat and Inter need a web-font request.
      {
        rel: "stylesheet",
