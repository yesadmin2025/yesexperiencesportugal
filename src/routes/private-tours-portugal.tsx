          ...
          <div className="container-x max-w-2xl">
            ...
            <aside className="mt-16 pt-12 border-t border-[color:var(--gold-soft)]/40 text-center">
              ...
              <ul className="flex flex-wrap justify-center gap-x-6 gap-y-3 text-[13px] uppercase tracking-[0.2em] text-[color:var(--charcoal-soft)]">
                ...
                <li>
                  <Link to="/local-stories/$slug" params={{ slug: "portugal-wine-tours" }} className="hover:text-[color:var(--teal)]">
                    Portugal wine tours →
                  </Link>
                </li>
                <li>
                  <Link to="/local-stories/$slug" params={{ slug: "best-day-trips-from-lisbon" }} className="hover:text-[color:var(--teal)]">
