        ...
        <header className="reveal pt-32 md:pt-40 pb-12 md:pb-16 bg-[color:var(--sand)]">
          <div className="container-x max-w-3xl text-center">
            ...
            <SectionTitle as="h1" size="anchor" spacing="loose">
              Private Wine Tour from Lisbon — <SectionTitle.Em>Arrábida & Azeitão</SectionTitle.Em>
            </SectionTitle>
            ...
            <div className="mt-4 pt-12 border-t border-[color:var(--gold-soft)]/40">
              ...
              <div className="mt-10 p-6 md:p-8 bg-[color:var(--charcoal)] text-[color:var(--ivory)] text-center">
                ...
                <p className="text-[14px] text-[color:var(--ivory)]/80 leading-[1.7] mb-5 max-w-md mx-auto">
                  Pick the wineries, the lunch, the close — route, timing and price update as you
                  go.
                </p>
