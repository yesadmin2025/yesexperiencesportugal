...
/**
 * /private-tours-comporta → /private-tours-comporta-troia#comporta (301).
 *
 ...
 */
export const Route = createFileRoute("/private-tours-comporta")({
  loader: () => {
    throw redirect({ href: "/private-tours-comporta-troia#comporta", statusCode: 301 });
  },
});
