...
/**
 * /private-tours-sesimbra → /private-tours-arrabida-sesimbra#sesimbra (301).
 *
 ...
 */
export const Route = createFileRoute("/private-tours-sesimbra")({
  loader: () => {
    throw redirect({ href: "/private-tours-arrabida-sesimbra#sesimbra", statusCode: 301 });
  },
});
