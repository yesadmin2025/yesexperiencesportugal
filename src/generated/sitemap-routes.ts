...
export const SITEMAP_STATIC_ROUTES: SitemapRoute[] = [
  ...
  { path: "/private-tours-azeitao", changefreq: "monthly", priority: "0.7" },
  { path: "/private-tours-azeitao-setubal", changefreq: "monthly", priority: "0.7" },
  { path: "/private-tours-cascais", changefreq: "monthly", priority: "0.7" },
  ...
  { path: "/private-tours-sintra", changefreq: "monthly", priority: "0.7" },
  { path: "/private-tours-sintra-cascais", changefreq: "monthly", priority: "0.7" },
  { path: "/private-tours-troia", changefreq: "monthly", priority: "0.7" },
