...
export function SignatureRouteMapFallback({ tour, reason }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-2 right-2 text-[11px] uppercase tracking-[0.2em] text-[color:var(--charcoal-soft)] bg-[color:var(--ivory)]/90 px-2 py-1 rounded border border-[color:var(--gold)]/30">
