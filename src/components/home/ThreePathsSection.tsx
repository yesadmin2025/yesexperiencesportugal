...
const PATHS: Path[] = [
  {
    ...
    body: (
      <>
        Flagship private days across Portugal — Arrábida, Comporta, the wild Vicentine coast and
        hidden Alentejo.
      </>
    ),
  ...
  },
  {
    ...
    title: (
      <>
        Build it live.{" "}
        <span className="italic font-normal text-[color:var(--teal)]">Reserve in minutes.</span>
      </>
    ),
          ...
          {PATHS.map((p) => {
            ...
            const Inner = (
              <>
                ...
                <span className="mt-4 inline-flex items-center gap-2 text-[11px] uppercase tracking-[0.28em] font-semibold text-[color:var(--teal)]">
                  {p.label}
                </span>
