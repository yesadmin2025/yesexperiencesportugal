      ...
      <div className="relative z-10 w-full max-w-md px-6 text-center animate-in fade-in slide-in-from-bottom-1 duration-[1100ms]">
        ...
        <form onSubmit={handleSubmit} className="mt-8 flex flex-col items-center gap-4">
          ...
          <button
            type="button"
            onClick={onSkip}
            className="inline-flex items-center min-h-[36px] px-3 text-[11px] uppercase tracking-[0.22em] font-semibold text-[color:var(--text-on-dark-muted)] hover:text-[color:var(--ivory)]/85 transition-colors"
          >
            {skipLabel}
          </button>
        </form>
