        ...
        <li
          ...
          className={
            isAiLine
              ...
              : "text-[11px] uppercase tracking-[0.32em] font-medium text-[color:var(--ivory)]/70 transition-opacity duration-700 motion-reduce:transition-none"
          }
          style={{
            opacity: reveal > 0 ? 1 : 0,
            fontFamily: isAiLine ? "var(--font-editorial)" : undefined,
          }}
        >
          {eyebrow}
        </li>
