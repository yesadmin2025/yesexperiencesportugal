...
const sizeClasses = {
  default:
    "text-[clamp(1.875rem,7vw,2.4rem)] md:text-[3.6rem] leading-[1.14] md:leading-[1.08] text-balance",
  anchor:
    "text-[clamp(2.125rem,7.5vw,2.8rem)] md:text-[4rem] leading-[1.12] md:leading-[1.06] text-balance",
  compact:
