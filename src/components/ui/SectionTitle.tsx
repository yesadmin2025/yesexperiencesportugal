...
const sizeClasses = {
  default:
    "serif-title text-[clamp(1.875rem,7vw,2.4rem)] md:text-[3.6rem] leading-[1.1] md:leading-[1.0] tracking-[-0.018em] text-balance",
  anchor:
    "serif-title text-[clamp(2.125rem,7.5vw,2.8rem)] md:text-[4rem] leading-[1.05] md:leading-[0.98] tracking-[-0.02em] text-balance",
  compact:
    "serif-title text-[clamp(1.6rem,5.5vw,1.95rem)] md:text-[2.4rem] leading-[1.18] md:leading-[1.1] tracking-[-0.012em] text-balance",
} as const;
