      ...
      >
        ...
        <div className="relative px-5 sm:px-7 pt-6 pb-4 border-b border-[color:var(--border)] bg-[color:var(--ivory)]">
          ...
          <p
            ...
            className="mt-2 text-[12px] uppercase tracking-[0.14em] text-[color:var(--charcoal)]"
          >
  ...
  return (
    ...
    >
      ...
      {total != null ? (
        ...
        >
          <span className="text-[12px] uppercase tracking-[0.2em] font-medium text-[color:var(--charcoal)]">
            Total
          </span>
      ...
      {hasDetails ? (
        <>
          <button
            ...
            className="mt-1 flex min-h-[44px] w-full items-center justify-between gap-2 text-left text-[12.5px] uppercase tracking-[0.16em] text-[color:var(--charcoal-soft)] hover:text-[color:var(--charcoal)]"
          >
            <span>Details</span>
            <ChevronDown
              size={14}
          ...
          {open ? (
            <div className="pb-2" data-testid="checkout-drawer-details">
              {hasBands ? (
                ...
                >
                  <p className="mt-2 text-[12px] uppercase tracking-[0.18em] font-medium text-[color:var(--charcoal)]">
                    Travellers
                  </p>
              ...
              {hasAddOns ? (
                <div className="mt-3 pt-2 border-t border-[color:var(--border)]">
                  <p className="text-[12px] uppercase tracking-[0.18em] font-medium text-[color:var(--charcoal)]">
                    Add-ons
                  </p>
                  <ul className="mt-1.5 space-y-1">
...
function CheckoutSkeleton() {
  return (
    <div className="px-3 py-6 space-y-3" aria-hidden>
      ...
      <div className="h-10 bg-[color:var(--sand)]/60 animate-pulse" />
      <p className="text-center text-[12.5px] tracking-[0.02em] text-[color:var(--charcoal-soft)] pt-2">
