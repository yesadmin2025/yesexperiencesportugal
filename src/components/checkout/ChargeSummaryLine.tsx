  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="mt-1 grid min-h-[44px] w-full grid-cols-[minmax(0,1fr)_auto] items-center gap-2 py-2 text-left text-[12.5px] text-[color:var(--charcoal)] hover:text-[color:var(--charcoal)]"
      >
        ...
        <span className="flex shrink-0 items-center gap-1 text-[11.5px] text-[color:var(--charcoal-soft)]">
          Price details
          <ChevronDown
            className={[
