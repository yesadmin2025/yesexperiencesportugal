  ...
  return (
    <div className="space-y-3">
      <div className="grid grid-cols-[minmax(0,1fr)_auto] items-baseline gap-3">
        <h3 className="min-w-0 text-[12.5px] font-medium uppercase tracking-[0.17em] text-[color:var(--charcoal)]">
          {title}
        </h3>
        {optional ? (
          <span className="shrink-0 text-[12px] uppercase tracking-[0.15em] text-[color:var(--charcoal-soft)]">
            Optional
          </span>
        ) : null}
      </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          aria-hidden
          className="shrink-0 text-[12px] uppercase tracking-[0.16em] text-[color:var(--teal)]"
        >
          Optional
        </span>
      </summary>
