              ...
              >
                ...
                {onEditOperational ? (
                  <button
                    ...
                    className="ml-auto min-h-[44px] px-2 text-[11.5px] uppercase tracking-[0.2em] font-semibold text-[color:var(--teal)]"
                  >
                    Change
                  </button>
                ) : null}
                ...
                >
                  ...
                  {onEditOperational ? (
                    <button
                      ...
                      className="min-h-[44px] px-2 text-[11.5px] uppercase tracking-[0.2em] font-semibold text-[color:var(--teal)]"
                    >
                      Change
                    </button>
                  ) : null}
