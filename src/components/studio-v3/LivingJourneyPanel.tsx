        ...
        <div className="px-5 pt-5 pb-4">
          ...
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0">
              ...
              {memoryLine ? (
                <MemoryRewriteLine line={memoryLine} />
              ) : null}
            </div>
            <button
              type="button"
              ...
              {storyLoading && !storyText ? (
                ...
                >
                  <div
                    ...
                    style={{ background: "color-mix(in oklab, var(--charcoal) 8%, transparent)", width: "92%" }}
                  />
                  <div
                    className="h-3 rounded-sm animate-pulse"
                    style={{ background: "color-mix(in oklab, var(--charcoal) 8%, transparent)", width: "76%" }}
                  />
                </div>
              ) : (
                <p
