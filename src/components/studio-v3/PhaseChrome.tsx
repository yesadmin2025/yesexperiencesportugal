...
export function BackLink({ onClick }: { onClick: () => void }) {
  return (
    <button
      ...
      className="absolute z-30 left-3 top-[max(10px,env(safe-area-inset-top))] sm:left-4 sm:top-4 inline-flex items-center gap-1.5 min-h-[44px] min-w-[44px] px-2 text-[11px] uppercase tracking-[0.24em] font-semibold focus:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--gold)]"
