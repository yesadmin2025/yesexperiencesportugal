...
export const CORPORATE_SERVICE_IMAGES: EditorialImageSource[] = [
  image("azeitao-group-tasting", {
    ...
    alternate: image("tasting-flight-full", {
      alt: "A complete hosted Portuguese wine flight prepared for private guests.",
      width: 1920,
      height: 1440,
      objectPosition: "50% 50%",
    }),
  }),
  image("arrabida-team-viewpoint", {
    alt: "Private group pausing together above the Arrábida coast during a hosted day.",
    width: 1600,
    height: 1065,
    objectPosition: "50% 42%",
    alternate: image("moscatel-giant-vats-guide", {
  ...
  image("alentejo-group-ruins", {
    alt: "Private guests sharing a hosted cultural moment among Roman ruins in Alentejo.",
    width: 1600,
    height: 1058,
    objectPosition: "50% 46%",
    alternate: image("arrabida-viewpoint-group", {
      alt: "Private group with their local host at the Serra da Arrábida viewpoint.",
      width: 1824,
      height: 1368,
...
export const PROPOSAL_SERVICE_IMAGES: EditorialImageSource[] = [
  ...
  image("wine-cheers-arch", {
    ...
    height: 1800,
    objectPosition: "50% 48%",
    alternate: image("tasting-cake-moment", {
      alt: "Friends sharing cake and a wine tasting around a table in Portugal.",
      width: 1920,
      height: 1440,
      objectPosition: "50% 48%",
    }),
  }),
  image("azulejo-private-workshop", {
    alt: "Private guests painting traditional azulejos together in a Portuguese workshop.",
    width: 1600,
    height: 1066,
    objectPosition: "50% 46%",
    alternate: image("couple-vineyard", {
