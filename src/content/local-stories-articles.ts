...
export const LOCAL_STORIES_ARTICLES: LocalStoryArticle[] = [
  ...
  },
  {
    ...
    title: "Is a Wine Tour from Lisbon Worth It? An Honest Answer",
    metaDescription:
      "Is a wine tour from Lisbon worth it? A local operator's honest answer — when it shines, when to skip it, and how to choose the right wine day.",
  ...
  },
  {
    ...
    title: "Best Wine Regions Near Lisbon: A Local Comparison",
    metaDescription:
      "The best wine regions near Lisbon compared — Arrábida, Setúbal and Alentejo — with local advice on drive time, wine style and the right day trip.",
  ...
  },
  {
    ...
    title: "Arrábida vs Alentejo: Which Wine Day Trip to Choose",
    metaDescription:
      "Arrábida or Alentejo for your wine day trip from Lisbon? Coast and Moscatel vs cork oaks and talhas — an honest local comparison to help you pick.",
  ...
  },
  {
    ...
    metaDescription:
      "The best wineries near Lisbon, chosen by locals — family cellars in Arrábida and Setúbal, Moscatel tastings and traditional talha wine in Alentejo.",
  ...
  // -----------------------------------------------------------------------
  {
    ...
    title: "Arrábida Day Trip from Lisbon: Wine, Hills & Beaches",
    metaDescription:
      "A private Arrábida day trip from Lisbon — Setúbal's market, family wineries in Azeitão, coves below the ridge and a long Portuguese lunch.",
  ...
  },
  {
    ...
    metaDescription:
      "A private Arrábida wine tour from Lisbon — family wineries, Azeitão cheese, Setúbal's market, coastal scenery and an unhurried Portuguese lunch.",
  ...
  },
  {
    ...
    title: "Private Wine Tours in Portugal: Lisbon to Alentejo",
    metaDescription:
      "Private wine tours across Portugal — Arrábida and Setúbal near Lisbon, Alentejo's talha cellars, family wineries and long local lunches.",
  ...
  },
  {
    ...
    title: "Lisbon Neighborhoods: A Local Guide to Where to Stay",
    metaDescription: "A local guide to Lisbon neighborhoods, from Baixa and Alfama to Príncipe Real and Belém, with an honest sense of pace, hills and atmosphere.",
    h1: "Lisbon Neighborhoods, Read by Rhythm",
    eyebrow: "Lisbon · Neighborhoods",
    standfirst: "Lisbon is not one city mood. The right neighborhood changes how every morning and evening of your trip feels.",
    sections: [
    ...
    ctaLead: "Once you know where Lisbon begins for you, choose the landscape you want beyond it.",
  ...
  },
  {
    ...
    title: "Portuguese Culture: What First-Time Visitors Should Know",
    metaDescription: "A thoughtful local introduction to Portuguese culture: meal times, coffee, greetings, tipping, pace and the small courtesies that shape a better visit.",
    h1: "Portuguese Culture, in the Small Things",
    eyebrow: "Portugal · Local Culture",
    standfirst: "The useful cultural differences are rarely dramatic. They live in timing, tone, food and the way a day is allowed to unfold.",
    sections: [
    ...
    ctaLabel: "See our private experiences",
    signatureSlug: "arrabida-wine-allinclusive",
    relatedReads: [
  ...
  {
    slug: "must-visit-places-near-lisbon",
    title: "Must-Visit Places Near Lisbon — A Local Shortlist",
    metaDescription: "The must-visit places near Lisbon, chosen by mood: Sintra, Arrábida, Sesimbra, Azeitão, Évora and Comporta, with honest drive times.",
    h1: "Must-Visit Places Near Lisbon, Chosen by Mood",
    eyebrow: "Lisbon · Places Worth the Drive",
    standfirst: "Not every famous place belongs in the same trip. This is the shortlist we use when a guest tells us how they want the day to feel.",
    sections: [
    ...
    comparison: {
      caption: "Choose by mood",
      columns: ["Place", "From Lisbon", "Best for", "Natural pairing"],
      rows: [
        ["Sintra", "about 40 min", "Palaces and gardens", "Cascais coast"],
        ["Arrábida & Azeitão", "about 40 min", "Wine and viewpoints", "Sesimbra"],
        ["Évora & Alentejo", "about 1h30", "History and talha wine", "Cork country"],
        ["Comporta & Tróia", "about 1h", "Beaches and quiet", "Sado ferry"],
      ],
    },
    ctaLead: "Choose the feeling first. The route, pickup and live price are clear before you pay.",
    ctaLabel: "Compare day trips from Lisbon",
    signatureSlug: "arrabida-wine-allinclusive",
    relatedSignatures: [
      { slug: "sintra-cascais", label: "Sintra & Cascais" },
      { slug: "evora-alentejo", label: "Évora & Alentejo" },
