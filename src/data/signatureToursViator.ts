...
export const VIATOR_META: Record<string, ViatorMeta> = {
  "arrabida-wine-allinclusive": {
    ...
    stops: [
      ...
      },
      {
        ...
        desc: "Step back in time in the rich history of Portugal at Castelo de Sesimbra, the last medieval castle that is still standing by the sea. Perched majestically atop a rugged hill overlooking the charming town of Sesimbra, this medieval castle offers panoramic views of the Atlantic Ocean and the surrounding countryside. Explore the ancient walls and towers of this well-preserved fo …",
      },
      {
        name: "Acesso Ponte 25 de Abril",
        desc: "For traveleres coming from Lisbon. The Portuguese Golden Gate, overlooking Lisbon and Tagus River.",
        passBy: true,
      },
      {
        name: "Ponte Vasco da Gama",
        desc: "For travelers coming from Lisbon. Built in 1998, is the second biggest Bridge in Europe, 17 kms long crossing the Tagus River. 11",
        passBy: true,
      },
      {
        name: "Santuario Nacional de Cristo Rei",
  ...
  "wild-beaches-picnic": {
    ...
    recommendedPct: 98,
    overview:
      "Skip the hassle of research and route planning and embark on a full-day, private adventure through Arrabida Natural Park and Sesimbra from Lisbon. Experience rugged landscapes, serene beaches, and local culture off the beaten path. Discover the historic fishing village of Sesimbra and its grand castle, enjoy panoramic views from Cabo Espichel, visit the Livramento Market in Setubal, and much more.",
    included: [
      "Private transportation",
    ...
    stops: [
      {
        name: "Mercado do Livramento",
        desc: "One of the best markets in world, where you can choose some delights for your picnic. Closed on Mondays.",
      },
      {
        name: "Parque Natural da Arrabida",
        desc: "Arrábida Mountain on Portugal's Setúbal Peninsula is a stunning natural gem, boasting rugged cliffs, lush forests, and golden beaches lapped by azure waters. Its striking geological formations create an enchanting coastline, while secluded coves offer picturesque beaches like Praia da Figueirinha and Praia dos Galapinhos. Adventure seekers can enjoy hiking, rock climb …",
      },
      {
        name: "Portinho da Arrabida",
        desc: "Portinho da Arrábida is a picturesque bay located in the Arrábida Natural Park on the coast of Portugal, near Setúbal. Known for its stunning natural beauty, the area features clear turquoise waters, white sandy beaches, and lush green hillsides. It is a popular spot for swimming, snorkeling, and hiking, offering visitors a tranquil escape amidst breathtaking scenery. The region  …",
      },
      {
      ...
      {
        name: "Cabo Espichel",
        desc: "We can explore Cabo Espichel or Sesimbra Castle. Cabo Espichel, or Espichel Cape, is a stunning promontory located on the western coast of Portugal, near the town of Sesimbra. This rugged headland is renowned for its dramatic cliffs that tower above the Atlantic Ocean, offering breathtaking panoramic views of the sea and surrounding coastline. Atop the cape sits the …",
      },
      {
        name: "Praia das Bicas",
        desc: "Praia das bicas is another beautiful and wild beach in Sesimbra. You can have your picnic here.",
      },
      { name: "Praia do Meco", desc: "Admire the Praia do Meco we can enjoy our picnic here." },
      {
        name: "Praia de Foz",
        desc: "You can decide to do your picnic on any of the beaches on the itinerary. We will pass by all of they so you can enjoy the views",
        passBy: true,
      },
      {
        name: "Praia da Lagoa de Albufeira",
        desc: "We can also visit Praia da Lagoa de Albufeira and observe the birds and the nature around it. You can have your picnic here. 10",
        passBy: true,
      },
      {
        name: "Castelo de Sesimbra",
      ...
      {
        name: "Cristo Rei",
        desc: "Cristo Rei, or Christ the King, is a towering statue of Jesus Christ located in Almada, Portugal, overlooking the city of Lisbon across the Tagus River. Inspired by the Christ the Redeemer statue in Rio de Janeiro, Brazil, Cristo Rei stands at around 110 meters tall, including its pedestal. The monument was inaugurated in 1959 and has since become an iconic symbol of faith a …",
        passBy: true,
      },
      {
        name: "Ponte 25 de Abril",
        desc: "The 25th of April Bridge, also known as Ponte 25 de Abril in Portuguese, is a suspension bridge spanning the Tagus River in Lisbon, Portugal. Completed in 1966, the bridge was originally named the Salazar Bridge but was later renamed to commemorate the Carnation Revolution of April 25, 1974. With a total length of over 2.2 kilometers, it connects the city of Lisbon to t …",
        passBy: true,
      },
    ],
    topReviews: [
      {
        title: "Great trip outside of Lisbon city",
        author: "Joanna_R",
        date: "Jun 2024",
        text: "Our tour guide Nidia made this trip exceptional! She went above and beyond to tailor the experience to our preferences and was the perfect mix of personable and professional. Wonderful stops, scenery and the perfect place for a beach picnic!",
      },
      {
        title: "A day outside of Lisbon",
        author: "Ann_S",
        date: "Jun 2024",
        text: "The entire day was wonderful. We especially enjoyed the amazing sea views, And the visits to the food market to choose our picnic and the visit to the small tile factory.",
      },
      {
        title: "Girls trip",
        author: "Kelly_B",
        date: "Aug 2023",
        text: "Nice scenic views from the mountain. It was fun strolling around Sesimbra. Nuno was a personable guide. He was very polite and informative. We had a great time at the lagoon!",
      },
    ],
    gallery: [
  ...
  "arrabida-boat": {
    ...
    stops: [
      {
        name: "Mercado do Livramento",
        desc: "One of the best fresh marketplaces in the world is located in Setúbal and is called Mercado do Livramento. The market, which is well-known for its lively ambiance and gorgeous azulejo tiles, provides a wide selection of fresh fish, regional specialties, and products. For those who enjoy good food, this place is a must-visit as it perfectly embodies Portuguese culinary traditions.",
      },
      {
        name: "Parque Natural da Arrabida",
        desc: "Situated on the Portuguese coast, Arrábida Natural Park is a sanctuary of breathtaking scenery and abundant wildlife. Renowned for its verdant surroundings, undulating hills, and expansive vistas of the ocean, the park provides an ideal fusion of the natural world's splendor  …",
      },
      {
        name: "Lapa de Santa Margarida",
        desc: "Nestled within the Arrábida Natural Park lies a little-known jewel called Lapa de Santa Margarida. This magical sea cave provides guests a rare fusion of spiritual peace and natural beauty. It also has a small chapel devoted to Saint Mar …",
      },
      {
        name: "Castelo de Sesimbra",
        desc: "Sesimbra Castle is an ancient fortification perched on a mountaintop above the settlement with expansive views of the surrounding landscapes and sea. This well-preserved castle, which dates to the ninth century, has magnificent chapel, old wall …",
      },
      {
        name: "Sesimbra",
        desc: "Sesimbra is a charming fishing community on the Portuguese coast that is well-known for its exquisite beaches, mouthwatering seafood, and extensive maritime history. Sesimbra, which is sandwiched between the Atlantic Ocean and the Arrábida Natural Park, is known for its breathtak …",
      },
      {
        name: "Cabo Espichel",
        desc: "Famous for its breathtaking cliffs, expansive views of the ocean, and historical significance, Cabo Espichel is a spectacular coast close to Sesimbra. Both a quaint lighthouse and the well-known Sanctuary of Our Lady of the Cape are located on this p …",
      },
    ],
    topReviews: [
      {
        title: "Fantastic corporate team experience!",
        author: "Verified guest",
        date: "Mar 2026",
        text: "We booked this tour as a corporate team event while visiting Lisbon for a conference. Our group wanted something relaxed and authentic outside the city and this was perfect. The organization was excellent and everything ran smoothly for our group. The wineries were beautiful and the wine tastings were very well explained. The visit to Livramento Market was a highlight and lunch at a traditional Portuguese restaurant was fantastic. A great mix of wine, culture and scenery. Highly recommended for corporate groups visiting Lisbon.",
      },
      {
        title: "Fantastic experience!",
        author: "Verified guest",
        date: "Jul 2024",
        text: "Our full-day tour was absolutely incredible! Exploring the stunning landscapes of Arrábida and Sesimbra was truly unforgettable, with exciting activities, including a scenic boat tour. The dolphin",
      },
    ],
    gallery: [
  ...
  "tiles-workshop": {
    ...
    stops: [
      ...
      {
        name: "Castelo de Sesimbra",
        desc: "Nestled atop a windswept hill, Sesimbra Castle dated back the 9th century and reigns over the charming coastal town with timeless grace. Within its ancient walls lies a hidden gem: the castle's church adorned with over 10,000 meticulously crafted Portuguese tiles dating back to the 16th century. Each tile tells a story of craftsmanship and tradition, creating a mesmerizin …",
      },
      {
        name: "Sesimbra",
    ...
    topReviews: [
      {
        title: "Diego was friendly and",
        author: "Stephanie_C",
        date: "Feb 2026",
        text: "Diego was friendly and informative. He gave us wonderful suggestions and had lots of information about the area. Would recommend this tour!",
      },
      {
        title: "Enjoy the views and tile workshop!",
        author: "Sarah_J",
        date: "Aug 2025",
        text: "Wonderful, unique, and hands-on tour with a knowledgeable guide! We got to see sights and viewpoints we normally wouldn’t know to do on our own.",
      },
      {
        title: "Of all the activities we",
        author: "iciclejam",
        date: "May 2025",
        text: "Of all the activities we booked in Lisbon, this was the one I was most excited about. It had all the makings of an incredible experience—until I got sick at our very first stop. Thankfully, our amazing tour guide João came to the rescue. He was super flexible and adjusted the itinerary to make things easier. If you’re thinking about booking this tour, definitely ask for João!",
      },
    ],
    gallery: [
    ...
    topReviews: [
      {
        ...
        author: "Verified guest",
        date: "Jun 2024",
        text: "This was an amazing day. We saw incredible views, made our very own cheese, and learned everything there is to know about making wine in Portugal. What an unforgettable experience! Our guide, Ricardo, was extremely gracious and knowledgeable. He knew everything and everybody and really helped make the day special. Highly recommend this trip, especially to get out of the hustle and bustle of Lisbon.",
      },
      {
        title: "A must try experience!",
        author: "Verified guest",
        date: "Mar 2024",
        text: "We an incredible time on a rainy day. Our tour guide, Nidiam, picked us up right from our hotel and made the day seamless. We started by visiting a gorgeous fresh market and taste local food and t",
      },
    ],
    gallery: [
  ...
  "troia-comporta": {
    ...
    stops: [
      ...
      {
        name: "Comporta Beach",
        desc: "If conditions allow, stop at one of Comporta’s famous wild beaches. Endless sand, untouched dunes and the Atlantic breeze create a sense of space and freedom that is hard to find elsewhere in Europe.",
      },
      {
  ...
  "evora-alentejo": {
    ...
    stops: [
      {
        name: "Ponte 25 de Abril",
        desc: "For traveleres coming from Lisbon. The Portuguese Golden Gate, overlooking Lisbon and Tagus River. 1",
        passBy: true,
      },
      {
        name: "Joao Portugal Ramos Wines",
        desc: "One of the Winery options on the itinerary. The winery embraces a modern approach to winemaking while respecting and honoring traditional winemaking techniques. João Portugal Ramos Winery is recognized for its diverse range of wines made from both indigenous Portuguese grape varieties and international varieties. Their portfolio includes white wines, such as  …",
      },
      {
        name: "Enoturismo Cartuxa",
        desc: "One of the options on the itinerary. The Adega Cartuxa got its name from the 16th century Mosteiro da Cartuxa (Cartuxa Monastery), which is situated right next to the winery and is part of the Eugénio de Almeida Foundation's patrimony. Excellence, quality, and individuality in a style of its own are the values recognized by consumers of the Cartuxa brand.",
      },
      {
      ...
      {
        name: "Ervideira",
        desc: "One of the Winery options on the itinerary. Ervideira is one of the secular wine companies in Portugal, dedicated to producing wine since 1880. It currently has the fourth and fifth generation of active producers. The estate has a total of 160 hectares of vineyards, distributed by family properties in Vidigueira and Reguengos. Since the beginning the mission was to create tr …",
      },
      {
        name: "Herdade do Esporao",
        desc: "One of the winery options. The Herdade do Esporão presents itself as an Estate steeped in history, producer of outstanding quality wines. The Esporão vines are located in the heart of Reguengos de Monsaraz, where wines are more balanced and seductive, simultaneously thriving and pleasant, luxuriant and with a good ageing potential. If the vines are the lung of the Herda …",
      },
      {
        name: "Chapel of Bones",
        desc: "The Chapel of Bones is a unique and intriguing attractions. It is a small chapel attached to the Church of St. Francis (Igreja de São Francisco) and is known for its macabre interior decoration. The chapel was built in the 16th century by Franciscan monks, with the purpose of conveying the message of life's transience and the importance of reflecting on mortality. The walls a …",
      },
      {
        name: "Evora",
        desc: "Évora is a UNESCO World Heritage site. The city dates back to Roman times and is full of ancient ruins, including a well-preserved Roman temple called the Temple of Diana. Évora is also famous for its well-preserved medieval walls, which enclose the historic center and offer stunning views of the city. The city's narrow streets are lined with beautiful whitewashed  …",
      },
      {
        name: "Templo Romano de Evora (Templo de Diana)",
        desc: "Also popularly known as Templo de Diana (Diana Temple), it was probably a place of worship to the Roman emperor of the time it was built. Located on the once Roman Forum of Evora and built in the beginning of the 1st century AD, this pagan monument of imposing proportions suffered different alterations during the Barbarian invasions and the Christian period. They a …",
      },
      {
        name: "Corticarte - Arte em Cortica",
        desc: "Visit a cork factory with a visit through the preparation process and explanations, from cork harvesting, quality selection and final products. There is a shop where you can get an authentic portuguese souvenir.",
      },
    ],
    topReviews: [
      {
        title: "Great guide for Alentejo and Évora",
        author: "Monica_W",
        date: "Jun 2025",
        text: "Miguel was a wonderful guide/driver for the day. He is from the area and provided a lot of history which we enjoyed, especially his stories of his days at the university in Evora. We were able to see everything we wanted and additional sights based on his recommendation. Great tour!",
      },
      {
        title: "We had a wonderful day",
        author: "laurie_V",
        date: "Apr 2025",
        text: "We had a wonderful day with Helena. I can’t imagine a better guide her choice of winery and a small tavern for an authentic Portuguese lunch were exactly what we were looking for. I cannot recommend her highly enough.",
      },
      {
        title: "Fantastic day with an excellent guide!",
        author: "marsim52",
        date: "Jun 2024",
  ...
  "fatima-nazare-obidos": {
    ...
    stops: [
      {
        name: "Fatima",
        desc: "\\- Visit the Sanctuary of Our Lady of Fatima, one of the most important pilgrimage sites in the world. \\- Explore the Basilica of Our Lady of the Rosary and the Chapel of the Apparitions. \\- Take some time for personal reflection and perhaps attend a mass or service if you wish.",
      },
      {
        name: "Nazare",
        desc: "Lunch (1 hour) \\- Enjoy a traditional Portuguese lunch. Drive for approximately 1.5 hours to reach Nazaré, a charming coastal town known for its stunning beach and big wave surf culture. \\- Visit Nazaré Beach and witness the breathtaking views from the Sitio da Nazaré viewpoint. \\- Explore the town's streets, shops, and restaurants.",
      },
      { name: "Praia da Nazare", desc: "Visit Nazaré beach." },
      {
        name: "Obidos",
        desc: 'Wander through the picturesque medieval streets, enclosed by the castle walls. \\- Don\'t miss the chance to try "ginjinha," a traditional Portuguese cherry liqueur, served in chocolate cups.',
      },
      {
        name: "Castelo de Obidos",
        desc: "Obidos' castle dates back to Portugal’s Roman occupation, but its current layout is Moorish and the result of restorations and reconstructions from different Portuguese kings, starting in 1148. The main towers were built in 1375, and in addition to its military function, it also served as a royal palace. The main building where the Portuguese king slept when he was in town is  …",
      },
    ],
    topReviews: [
      {
        ...
        author: "Michael_S",
        date: "Dec 2024",
        text: "We were very blessed to be able to attend Mass in Fatima. The fish drying on the beach in Nazare was incredible to see. Walking the ancient cobblestone streets in the medieval village surrounded by the castle and its walls were absolutely stunning. The shopping in the town was great. The Christmas decor and children’s rides were fantastic! Our tour guide (Helena) was fabulous! She is family now!",
      },
      {
        title: "Breathing tour with a great guide",
        author: "Luis_O",
        date: "Sep 2024",
        text: "A fantastic visit to Fatima, even if you are not catholic its still an impressive place. Being able to see the Basilica and other monuments was great. Moving towards Nazaré we were delighted by the",
      },
      {
        title: "Fatima, Nazaré, Obidos with family",
        author: "Christopher_A",
        date: "Aug 2024",
        text: "This was a fabulous tour. Our guide, Rafael, was great. Very attentive to our preferences and needs. I highly recommend this tour!",
      },
    ],
    gallery: [
  ...
  "roman-heritage-alentejo": {
    ...
    stops: [
      {
        name: "Villa Romana de Sao Cucufate",
        desc: "Step into the Roman past at one of the most important archaeological sites in Alentejo. Surrounded by quiet countryside, these ruins offer a glimpse into the Roman presence that helped shape the region's wine culture centuries ago — setting the perfect tone for the experience ahead.",
      },
      {
        name: "Centro Interpretativo do Vinho de Talha",
        desc: "Discover one of Portugal’s most unique wine traditions — the art of producing wine in clay vessels. This centuries-old method, dating back to Roman times, is still preserved in Alentejo today, making it one of the most authentic wine experiences in the country.",
      },
      {
        name: "Vila Alva",
        desc: "Drive through the charming village of Vila Alva and its surrounding landscapes, where time seems to slow down. Old vineyards, olive trees and traditional whitewashed houses reflect the rural life and deep-rooted traditions of Alentejo.",
      },
      {
        name: "Adega do Mestre Daniel - XXVI Talhas",
        desc: "Arrive at a small family-run winery where wine is still made using the ancient Roman clay method. This is not a standard visit, but a personal and immersive experience where guests are welcomed into a living tradition preserved through generations. Enjoy a long, relaxed lunch in a warm family atmosphere, where food, wine and conversation flow naturally. This is where th …",
      },
      {
        name: "Albergaria dos Fusos",
        desc: "During warmer months, enjoy a peaceful stop by this hidden river beach surrounded by nature. A perfect moment to relax and experience the quiet beauty of Alentejo.",
      },
    ],
    topReviews: [],
    gallery: [
