...
> = {
  ...
  "tiles-workshop": {
    ...
    itinerary: [
      ...
      { order: 4, label: "Tile Painting Workshop – Sesimbra", description: "In Sesimbra, join a private tile-painting workshop and delve into the artistry and heritage of Portuguese azulejos. Under the guidance of skilled artisans, craft your own ceramic tile masterpiece to take home.", durationMinutes: 120, travelToNextMinutes: null, optional: false },
