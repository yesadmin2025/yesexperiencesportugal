...
export const REGION_STOP_POOL: OptionalStop[] = [
  ...
  /**
   * INCLUDED MIDDAY TABLE — one per Signature whose Tailor Blueprint core
   * already includes a lunch. These are NOT new experiences: each one is the
   * blueprint's own published lunch inclusion, expressed in inventory space so
   * the composer can place the table at a real point in the day instead of
   * dropping it. Labels stay generic (no restaurant or supplier is named).
   * `durationMin` is a planning estimate for a seated regional lunch; it does
   * not change any price, inclusion or commercial rule.
   */
  {
    id: "lunch-azeitao-table",
    coords: { lat: 38.5167, lng: -9.0167 },
    region: "arrabida-setubal",
    subregion: "Azeit\u00e3o",
    name: "Long lunch in Azeit\u00e3o",
    type: "table",
    suitsInterests: ["gastronomy", "local-life", "wine"],
    suitsRhythm: ["slow", "balanced", "immersive"],
    suitsCompanions: ["solo", "couple", "family", "friends", "corporate"],
    suitsInvestment: ["considered", "elevated", "bespoke"],
    durationMin: 75,
    source: "signature-core",
    signatureTourId: "arrabida-wine-allinclusive",
    sourceTourIds: ["tiles-workshop", "azeitao-cheese"],
    routeCluster: "arrabida-azeitao-sesimbra",
    active: true,
    notes: "Blueprint core inclusion (lunch-azeitao). Generic label, no venue named.",
  },
  {
    id: "lunch-azenhas-table",
    coords: { lat: 38.8215, lng: -9.4655 },
    region: "sintra-cascais",
    subregion: "Sintra coast",
    name: "Lunch at Azenhas do Mar",
    type: "table",
    suitsInterests: ["gastronomy", "coast", "local-life"],
    suitsRhythm: ["slow", "balanced"],
    suitsCompanions: ["solo", "couple", "family", "friends"],
    suitsInvestment: ["considered", "elevated", "bespoke"],
    durationMin: 60,
    ...
    routeCluster: "sintra-cascais-coast-heritage",
    active: true,
    notes: "Blueprint core inclusion (lunch-azenhas). Generic label, no venue named.",
  },
  {
    id: "lunch-comporta-table",
    coords: { lat: 38.3878, lng: -8.7862 },
    region: "comporta-troia",
    subregion: "Comporta",
    name: "Lunch in Comporta",
    type: "table",
    suitsInterests: ["gastronomy", "local-life", "coast"],
    suitsRhythm: ["slow", "balanced"],
    suitsCompanions: ["solo", "couple", "family", "friends"],
    suitsInvestment: ["considered", "elevated", "bespoke"],
    durationMin: 60,
    ...
    routeCluster: "troia-comporta-coast",
    active: true,
    notes: "Blueprint core inclusion (comporta-lunch). Generic label, no venue named.",
  },
  {
    id: "lunch-evora-table",
    ...
    routeCluster: "evora-city-classical-wineries",
    active: true,
    notes: "Blueprint core inclusion (evora-lunch). Generic label, no venue named.",
  },
  {
    id: "lunch-tomar-table",
    coords: { lat: 39.6018, lng: -8.4117 },
    region: "tomar-coimbra",
    subregion: "Tomar",
    name: "Lunch en route",
    type: "table",
    suitsInterests: ["gastronomy", "local-life"],
    suitsRhythm: ["slow", "balanced"],
    suitsCompanions: ["solo", "couple", "family", "friends"],
    suitsInvestment: ["considered", "elevated", "bespoke"],
    durationMin: 60,
    ...
    routeCluster: "tomar-coimbra-heritage",
    active: true,
    notes: "Blueprint core inclusion (tomar-lunch). Generic label, no venue named.",
  },
  {
    id: "lunch-nazare-table",
    coords: { lat: 39.601, lng: -9.0707 },
    region: "fatima-nazare-obidos",
    subregion: "Nazar\u00e9",
    name: "Lunch in Nazar\u00e9",
    type: "table",
    suitsInterests: ["gastronomy", "coast", "local-life"],
    suitsRhythm: ["slow", "balanced"],
    suitsCompanions: ["solo", "couple", "family", "friends"],
    ...
    routeCluster: "fatima-nazare-obidos-spirit-coast",
    active: true,
    notes: "Blueprint core inclusion (nazare-lunch). Generic label, no venue named.",
  },
  {
    id: "lunch-talha-table",
    coords: { lat: 38.2569, lng: -7.9761 },
    region: "alentejo-evora",
    subregion: "Vila Alva",
    name: "Long Alentejo lunch",
    type: "table",
    suitsInterests: ["gastronomy", "wine", "local-life"],
    suitsRhythm: ["slow", "balanced", "immersive"],
    suitsCompanions: ["solo", "couple", "family", "friends"],
    suitsInvestment: ["considered", "elevated", "bespoke"],
    durationMin: 75,
    ...
    routeCluster: "vidigueira-roman-talha",
    active: true,
    notes: "Blueprint core inclusion (talha-lunch). Generic label, no venue named.",
  },
];
